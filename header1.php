            ...
            <div class="collapse navbar-collapse justify-content-between" id="nav">
                ...
                <div class="dropdown ml-3">
                    ...
                    <div class="dropdown-menu bg-dark" aria-labelledby="user" id="userdrop">
                        <a href="" id="manage" class="dropdown-item red" data-toggle='modal' data-target='#myModal1'><span class="fa fa-cog"></span> Manage Account</a>
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header alert-dark">
                        <h5 class="modal-title" id="exampleModalLabel1">UPDATE INFORMATION</h5>
